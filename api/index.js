...
safeMount('/api', 'routes/visitor', () => require('./routes/visitor'));
safeMount('/api', 'routes/holds', () => require('./routes/holds'));
safeMount('/api', 'routes/bot-training', () => require('./routes/bot-training'));
