...
// Derive from current script's src — Shopify Script Tags API doesn't
// let us set data-api, so the auto-installed n.js loads without it.
// Inferring from script.src origin keeps both manual-paste and
// auto-install paths working without any merchant intervention.
const API_BASE = (() => {
  try {
